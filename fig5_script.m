...
for i = 1:4
    ...
    yticks([0 18000 36000 54000]);
    yticklabels([0 180 360 540]);
...
for i = 1:4
    ...
    yticks([0 18000 36000 54000]);
    yticklabels([0 180 360 540]);
    title(['S^{ext}=',num2str(sexs((i-1)*3+1),'%4.1f'),'×','10^{-2}']);
    view([-25,45]);
    xlim([0 72000]);
    ylim([0 54000]);
    set(gca,'fontsize',15,'fontname','Arial');
...
title(['\tau_E =', num2str(ptauEs(i)),' times orginal values']);
    ...
    if i ==1
        ...
        xlim([0 72000]*2);
        ylim([0 60000]*3);
        xticks([0 36000 72000]*2);
        xticklabels([0 360 720]*2);
        yticks([0 20000 40000 60000]*3);
        yticklabels([0 200 400 600]*3);
    end
    set(gca,'fontsize',15,'fontname','Arial');
end
set(gcf,'Position',[10,10,1600,300]);
